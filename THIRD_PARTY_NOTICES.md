...
- KHALINOS includes two bounded, profile-specific composed atlases made from user-approved AetherAI free assets under the AetherAI Free Asset License dated 2026-06-29, together with source-selection and license receipts. They are included as game components for Trinity and side-scroll generation. The original catalog remains external and is not redistributed as a standalone KHALINOS asset pack. The full catalog may be used only through the explicit licensed-root override, which revalidates source hashes and fails closed.
