...
### Capture-readiness qualification (latest)

The final capture-preparation build is commit `5a9671a`, deployed to service revision `khalinos-00069-cpm`; the API and Worker use the same immutable image digest, `sha256:a765d784b81c151233c55aeb56fb08e95ad63f41495319d020f18ee6fcad4b1c`. Side-scroll run `40012e3058c3422aabc37a1d94c9ca0b` / execution `khalinos-worker-wxwxd` passed 30/30 checks with three receipts, 12 Gemini calls, and zero issues. The selected V3 has no castle or repeated tree/rock icons and uses ridge-and-mist parallax; artifact SHA-256 is `61c618bb…24f8a6` and bundle SHA-256 is `f497f333…ffc38d`.

Trinity run `abfcb1ae60ba44608c351552231578c0` / execution `khalinos-worker-rhhzb` passed 59/59 checks with four receipts, 13 Gemini calls, and zero issues. The selected V3 keeps the party centered over scrolling top-down terrain without the side-scroll road band or decorative unit rings; artifact SHA-256 is `38e7dd13…003f6` and bundle SHA-256 is `665aa423…a5adb`. A rejected SixSense completion criterion was corrected without lowering gameplay or rendering gates and is preserved in the evidence record. Exact digests, run IDs, receipts, OBS preparation, and correction history are in [`capture-readiness-cloud-qualification-20260825.json`](docs/evidence/capability-pack-composition/capture-readiness-cloud-qualification-20260825.json).

### Final two-profile release qualification (historical release tag)
